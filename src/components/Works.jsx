...
import Skills from "./Skills";             // <-- on importe Skills
import { textVariant } from "../utils/motion";

const tabs = [
    { id: "projects",       label: "Projects" },
    { id: "certifications", label: "Certifications" },
    { id: "skills",         label: "Skills" },  // <-- nouvel onglet
];
    ...
    return (
        <>
            ...
            <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px] text-center mx-auto">
                ...
                {activeTab === "skills" &&
                    "Interactive radar to explore my core skill areas."}
            </p>

            {/* Contenu selon onglet */}
            {activeTab === "skills" ? (
                // intègre la section Skills
                <Skills />
            ) : (
