...
const projects = [
    {
        ...
        description:
            "Autonomous report after GISEC 2025 for a fintech SME: field analysis, synthesis of cyber solutions (Veracode, Fortinet, Microsoft...), creation of a Power BI dashboard focused on risks, compliance (GDPR, DORA, ISO) and cyber strategy. Full GRC perspective.",
        tags: [
            {
                name: "Ebios RM",
    ...
    },
    {
        ...
        description:
            "Development of a PHP/React application generating quizzes using AI. Team coordination, agile project management, and final pitch with PowerPoint presentation. Strong focus on collaboration and integration.\u00A0\u00A0",
        tags: [
            {
                name: "AI",
                color: "blue-text-gradient",
    ...
    },
    {
        ...
        description:
            "Deployment and configuration of an Apache web server in a lab context, followed by network traffic analysis using Wireshark. This project introduced core concepts of service setup, port analysis, and packet inspection for cybersecurity purposes.",
        tags: [
            {
                name: "Networking",
                color: "blue-text-gradient",
